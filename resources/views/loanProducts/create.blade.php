                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" name="start_date" class="form-control" value="0" required>
                                    </div>
                                </div>
                                <div class="col-6 row">
                                    <label for="end_date" class="col-sm-4 col-form-label">End at </label>
                                    <div class="col-sm-8">
                                        <input type="date" name="end_date" class="form-control" value="0">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="interest_rate" class="form-control" value="0" required>
                                    </div>
                                </div>
                                <div class="col-6 row">
