            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6 text-Left">
                        <h4><i class="nav-icon fas fa-address-card text-blue"></i> <strong>Master Data</strong> | Services
                            Management</h4>
                    </div>
                    <div class="col-sm-6 text-right">
                        <h6> <strong>Master Data</strong> > <i class="nav-icon fas fa-star text-blue"></i> Edit Services</h6>
                    </div>
                </div>
                <div class="row mb-2">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $service->code }}" name="code" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" min="1" value="{{ $service->unit_price }}" name="unit_price" class="form-control" required>
                                    </div>
                                </div>
                                {{--                                <div class="col-6 row">--}}
