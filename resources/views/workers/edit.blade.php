            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <h6> <strong>Stock Management</strong> > <i class="nav-icon fas fa-users text-yellow"></i> Edit Workers</h6>
                    </div>
                </div>
                <div class="row mb-2">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $worker->service_no }}" name="service_no" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-6 row">
                                    <label for="rank" class="col-sm-4 col-form-label">Rank</label>
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $worker->rank }}" name="rank" class="form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $worker->name }}" name="name" class="form-control" required>
                                    </div>
                                </div>
                                <div class="col-6 row">
                                    <label for="regiment" class="col-sm-4 col-form-label">Regiment</label>
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $worker->regiment }}" name="regiment" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" value="{{ $worker->mobile }}" name="mobile" class="form-control">
                                    </div>
                                </div>
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <select name="status" class="col-sm-6 form-control" data-live-search="true">
                                            ...
                                            <option value="1" {{ $worker->status == 1 ? 'selected' : '' }}>Yes</option>
                                            <option value="0" {{ $worker->status == 0 ? 'selected' : '' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
