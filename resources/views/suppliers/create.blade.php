            ...
            <div class="container-fluid">
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6 text-right">
                        <h6> <strong>Stock Management</strong> > <i class="nav-icon fas fa-users text-yellow"></i> Create Suppliers</h6>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-sm-12 text-right">
                        <a href="{{ route('suppliers.index') }}" class="btn btn-sm btn-outline-warning">Back</a>
                    </div>
                </div>
            </div>
        </section>
