    ...
    <div class="row">
        ...
        <div class="col-lg-8 col-md-9">
            ...
            <div class="page-content page-col">
                ...
                <h1 class="wow fadeInUp">Digital Offset Printing</h1>
                ...
                <div class="wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <ul>
                        ...
                        <li>Leaflets, Brochures, Flyers</li>
                        <li>Stickers</li>
                        <li>Posters and Notices</li>
                        <li>CD/DVD Covers and Labels</li>
                        <li>Annual and Project reports</li>
                    </ul>
                    <p>&nbsp;</p>
