                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                <div class="col-6 row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="number" name="year" value="{{ date('Y') }}" class=" col-sm-5 form-control" required>
                                    </div>
                                </div>
                                <div class="col-6 row">
                                    <label for="month" class="col-sm-4 col-form-label">Deposit Month</label>
                                    <div class="col-sm-8">
                                        <input type="number" name="month" value="{{ date('m') }}" class="col-sm-5 form-control" required>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row">
